...
+
Par exemple, téléchargez le `jdk-17.0.15_windows-x64_bin.zip` fichier delink:https://www.oracle.com/java/technologies/javase/jdk17-0-13-later-archive-downloads.html["la page de téléchargement des archives Oracle Java SE 17"^] .

+

NOTE: Un compte Oracle est requis pour télécharger le fichier. Si vous ne possédez pas de compte Oracle, rendez-vous sur link:https://signon.oracle.com/signin["page de connexion au compte Oracle"] en créer un.
