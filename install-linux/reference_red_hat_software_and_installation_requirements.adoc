...
* Red Hat Enterprise Linux versions 8.x et 9.6, basées sur l'architecture x86_64.
...
* OpenJDK version 17.0.14+6 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
* Python 3.12 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
