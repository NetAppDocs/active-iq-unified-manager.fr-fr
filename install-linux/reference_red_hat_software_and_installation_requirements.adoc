...
* MySQL Community Edition version 8.0.37 (à partir du référentiel MySQL).
* OpenJDK version 11.0.23 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
