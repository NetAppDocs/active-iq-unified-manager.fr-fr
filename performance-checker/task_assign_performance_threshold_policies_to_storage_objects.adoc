...
Tous les objets de la page
 a| 
Le image:../media/select_dropdown_65_png.gif[""] Et choisissez *Sélectionner tous les objets sur cette page*.
...
Tous les objets du même type
 a| 
Le image:../media/select_dropdown_65_png.gif[""] Et choisissez *Sélectionner tous les objets*.
