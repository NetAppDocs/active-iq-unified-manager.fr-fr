...
** Données inactives supérieures à 10 Goimage:../media/filter_cold_data_2.png[""]
...
+
image::../media/report_vol_code_data_2.png[signaler les données du code vol 2]
...
+
image::../media/scheduled_reports_3.gif[rapports planifiés 3]
...
+
image::../media/csv_sample_report.gif[exemple de rapport csv]

+
L'exemple de rapport suivant est au format PDF :

+
image::../media/pdf_sample_report.gif[modèle de rapport pdf]
