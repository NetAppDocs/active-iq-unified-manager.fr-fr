...
Pour en savoir plus sur la continuité de l'activité SnapMirror synchrone, reportez-vous à link:https://docs.netapp.com/us-en/ontap/smbc/index.html["Documentation ONTAP 9 pour SM-BC"].
